# Not using this camera cause we have Phantom Camera
...
func _ready() -> void:
	...
	# Used these in the old dialogue implementation before Dialogic
...
func _process(delta: float) -> void:
	...
	# Camera moves a bit ahead of the player
	...
	# Could be useful in the platformer area
	if looking_up:
